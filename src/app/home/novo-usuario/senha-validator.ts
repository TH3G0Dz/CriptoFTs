...
export function validarCaracterEspecial(control: AbstractControl): { [key: string]: boolean } | null {
...
export function validarLetraMaiuscula(control: AbstractControl): { [key: string]: boolean } | null {
...
export function validarNumero(control: AbstractControl): { [key: string]: boolean } | null {
  const numero = /[0-9]/;
  const senha = control.value;
